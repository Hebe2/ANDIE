...
public class ImageRotation90clockwise implements ImageOperation, Serializable {
     ...
     *
     * <p>
     * The image is rotated 90 degrees clockwise about its centre point. The
     * output image has its width and height swapped relative to the input to
     * accommodate the rotated content.
     * </p>
     *
